...
This tutorial builds on contents covered in *Applied Geodata Science*, chapters [Data Wrangling](https://geco-bern.github.io/agds_book/data_wrangling.html) and [Random Forest](https://geco-bern.github.io/agds_book/randomforest.html).
:::
...
-   Spatial Data Visualization: Visualizing spatial data through maps and interactive visualizations helps communicate complex spatial information effectively. A brief introduction to working with geospatial data in R is given [here](https://geco-bern.github.io/handfull_of_pixels/geospatial_R.html). 
...
If you want to learn more about the underlying theory and similar techniques, we highly recommend the presentations by Madlene Nussbaum given at the summer school of the OpenGeoHub Foundation (see [part 1](https://www.youtube.com/watch?v=NgZ17CbL_xs) and [part 2](https://www.youtube.com/watch?v=idkODq0BpAA)) and her papers: @nussbaum2017, @nussbaum2018evaluation).
